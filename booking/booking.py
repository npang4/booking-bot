...
class Booking(webdriver.Chrome):
    ...
    def select_dates(self, checkin_date, checkout_date):
        checkin_element = self.find_element(By.CSS_SELECTOR, f'td[data-date="{checkin_date}"]')
        checkin_element.click()

        checkout_element = self.find_element(By.CSS_SELECTOR, f'td[data-date="{checkout_date}"]')
